...
const timeStamp = new Date('June 28, 2023, 16:30:00');
...
simpleTimeStamp = timeStamp.toDateString();
...
dutchTimeStamp = timeStamp.toLocaleDateString("nl-NL", optionsNL);

console.log(dutchTimeStamp);